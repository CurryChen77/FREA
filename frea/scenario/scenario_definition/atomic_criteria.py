...
from frea.scenario.scenario_manager.traffic_events import TrafficEvent, TrafficEventType
...
class KeepLaneTest(Criterion):
    ...
    def __init__(self, actor, optional=False, name="CheckKeepLane"):
        ...
        world = CarlaDataProvider.get_world()
        blueprint = CarlaDataProvider._blueprint_library.find('sensor.other.lane_invasion')
