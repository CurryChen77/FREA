...
class RCSAC(BasePolicy):
    ...
    def __init__(self, config, logger):
        ...
        self.tau = config['tau']
        self.constrain_threshold = config['constrain_threshold']
    ...
    def train(self, replay_buffer):
        ...
        for _ in range(self.update_iteration):
            ...
            sample_next_action, _, _, _, _ = self.get_action_log_prob(bn_s_)  # future action
            excepted_Qh = self.Qh_net(bn_s_, sample_next_action)  # the expectation Qh about the future
    ...
    def save_model(self, episode):
        ...
        filepath = os.path.join(self.model_path, f'model.rcsac.{self.model_id}.{episode:04}.torch')
