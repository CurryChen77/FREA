...
def plot_multi_feasibility_region(args_dict):
    # load feasibility config
    feasibility_config_path = osp.join(args_dict['ROOT_DIR'], 'safebench/feasibility/config', args_dict['feasibility_cfg'])
    ...
    # set the logger
    log_path = osp.join(args.ROOT_DIR, 'safebench/feasibility/train_log', map_name)
    log_exp_name = map_name
    ...
    '''
    ego_obs1 = generate_ego_obs(ego_speed=4, yaw_range=(-1, 1), actor_num=actor_num, x_range=x_range, y_range=y_range, width=width, height=height)
    ...
    ego_obs2 = generate_ego_obs(ego_speed=6, yaw_range=(-1, 1), actor_num=actor_num, x_range=x_range, y_range=y_range, width=width, height=height)
    ...
    ego_obs3 = generate_ego_obs(ego_speed=4, yaw_range=(2, 3.14), actor_num=actor_num, x_range=x_range, y_range=y_range, width=width, height=height)
    ...
    ego_obs4 = generate_ego_obs(ego_speed=4, yaw_range=(-3.14, -2), actor_num=actor_num, x_range=x_range, y_range=y_range, width=width, height=height)
...
if __name__ == '__main__':
    ...
    plot_multi_feasibility_region(args_dict)
